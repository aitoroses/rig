        ...
        + 'static,
{
    ...
    /// Create an extractor builder with the given completion model and explicit JSON schema.
    ...
    where
        U: JsonSchema + for<'a> Deserialize<'a> + Serialize + WasmCompatSend + WasmCompatSync,
    {
        self.extractor(model).with_schema_value(schema)
    }
    ...
    pub fn dynamic_extractor_with_schema(
        ...
        model: super::CompletionModels,
        schema: Value,
    ) -> ExtractorBuilder<super::responses_api::ResponsesCompletionModel<H>, Value> {
        self.extractor_with_schema(model, schema)
    }
        ...
        + 'static,
{
    ...
    pub fn dynamic_extractor_with_schema(
        ...
        model: super::CompletionModels,
        schema: Value,
    ) -> ExtractorBuilder<super::completion::CompletionModel<H>, Value> {
        self.extractor_with_schema(model, schema)
    }
